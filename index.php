...
<!-- <a href="logout.php" class="logout">Logout</a> --> <!-- | <a href="cetak.php" target="_blank">Cetak</a> -->
 ...
 <hr>
<a href="tambah.php" id="tambah" button type="tambah" class="btn btn-primary">Tambah data mahasiswa</button></a>
...
<table border="1" cellpadding="10" cellspacing="0" class="tabel">
	...
	<tr>
		...
		<td class="aksi">
			<a href="ubah.php?id=<?= $row["id"]; ?>" class="btn btn-success btn-sm"><i class="fa fa-fw fa-edit"></i>edit</a>
			<a href="hapus.php?id=<?= $row["id"]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('yakin?');"><i class="fa fa-fw fa-edit"></i>Delete</a>
		</td>
