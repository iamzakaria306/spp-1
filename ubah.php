  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	<form action="" method="post" enctype="multipart/form-data">
	  ...
	  <div class="form-group col-6">
	    ...
	    <input type="text" name="nama" value="<?= $mhs["nama"]; ?>" class="form-control" id="nama">
	  </div>

	  <div class="form-group col-6">
	    <label for="nrp">Nrp :</label>
	    <input type="text" name="nrp" required value="<?= $mhs["nrp"]; ?>" class="form-control" id="nrp">
	  </div>

	  <div class="form-group col-6">
	    <label for="email">Email :</label>
	    <input type="text" name="email" required value="<?= $mhs["email"]; ?>" class="form-control" id="email">
	  </div>

	  <div class="form-group col-6">
	    <label for="jurusan">Jurusan :</label>
	    <input type="text" name="jurusan" required value="<?= $mhs["jurusan"]; ?>" class="form-control" id="jurusan">
	  </div>


	  <div class="form-group col-6">
	  <label for="gambar">Gambar :</label> <br>
		<img src="img/<?= $mhs['gambar']; ?>" width="120" class="mb-3"> <br>
